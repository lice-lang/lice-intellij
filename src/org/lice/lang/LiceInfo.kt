...
object LiceInfo {
	...
	val KOTLIN_RUNTIME_PATH: String = File("../lib/kotlin-runtime.jar").absolutePath
	val KOTLIN_REFLECT_PATH: String = File("../lib/kotlin-reflect.jar").absolutePath
}
